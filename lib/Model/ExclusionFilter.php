...
class ExclusionFilter implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'operator_name' => '\Swagger\Client\Model\FilterOperatorName',
        'value' => 'string',
        'enabled' => 'bool'
    ];
     ...
     * Sets operator_name
     *
     * @param \Swagger\Client\Model\FilterOperatorName $operator_name operator_name
     *
     * @return $this
     */
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ExclusionFilter., must be smaller than or equal to 4000.');
        }
